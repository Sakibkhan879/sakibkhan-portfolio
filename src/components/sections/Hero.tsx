      ...
      >
        ...
        >
          <span className="inline-flex items-center gap-2.5 font-mono text-[10px] uppercase tracking-[0.3em] text-accent">
            <span aria-hidden className="inline-block h-1.5 w-1.5 rounded-full bg-accent shadow-accent-glow" />
          ...
          <p className="max-w-[36ch] font-mono text-[11px] uppercase tracking-[0.22em] text-zinc-300">
        ...
        {!loaded && (
          <div className="absolute inset-0 z-30 flex flex-col items-center justify-center gap-5 bg-background px-6">
            <EyebrowBadge>SAKIB KHAN // PORTFOLIO // LOADING</EyebrowBadge>
            ...
            <p className="font-mono text-[11px] uppercase tracking-[0.28em] text-zinc-500">
              Loading Portfolio &nbsp;&middot;&nbsp; {Math.round(loadProgress * 100)}%
            </p>
          </div>
        )}
      </div>
